  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="mt-1 text-title16 font-semibold text-text-primary md:text-h4">Receitas</h1>
      </div>
      <Card className="border-neutral-200/70 bg-white/95 shadow-[0_12px_40px_-24px_rgba(15,23,42,0.18)] ring-1 ring-black/[0.03]">
        <CardHeader className="border-b border-neutral-100/80">
          ...
          <p className="mt-1 text-small12 text-text-secondary">Esta área vai reunir receitas e sugestões alinhadas ao seu plano.</p>
        </CardHeader>
